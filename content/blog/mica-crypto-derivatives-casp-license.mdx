---
title: "MiCA License Explained: What a CASP Authorization Covers"
description: "What a MiCA license (CASP authorization) covers, the capital tiers, and why an EU crypto derivatives venue also needs MiFID — the misconception that costs operators."
cluster: "Regulation & Compliance"
keyword: "MiCA license"
date: "2026-06-22"
author: "GammaFloww Team"
---

MiCA — the EU's Markets in Crypto-Assets regulation — is the most significant crypto framework in the world, covering a 27-country single market. But there's a widespread misconception about what a **MiCA license** (a CASP authorization) actually permits: many assume it lets you run a crypto *derivatives* exchange. It doesn't — and understanding why will save you an expensive detour.
