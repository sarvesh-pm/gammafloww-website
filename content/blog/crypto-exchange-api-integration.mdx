...
description: "APIs connect market makers, algo traders and your own apps to your venue. The three protocols that matter and what a production-grade exchange API needs."
...
REST is the workhorse for actions and lookups. **WebSockets replace polling with continuous streams** — for order-flow trading they're effectively mandatory, because REST polling can't capture microsecond-level order-book changes ([Kalena](https://kalena.ai/blog/best-cryptocurrency-exchange-api-how-to-evaluate-websocket-feeds-order-book-depth-and-rate-limits-before-you-build-a-single-line-of-code)). **FIX** is what institutional counterparties expect; offering it signals you're ready for serious flow ([CryptoRank](https://cryptorank.io/news/feed/crypto-exchange-api-guide)).
