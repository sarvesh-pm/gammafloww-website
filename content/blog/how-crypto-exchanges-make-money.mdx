...
The primary revenue stream for almost every exchange is the [**maker–taker fee**](/blog/maker-taker-fees-explained) charged on each trade:
...
- **Funding payments are *not* exchange revenue.** On perpetual futures, the [funding rate](/blog/funding-rates-explained) is exchanged *directly between long and short traders* to keep the contract tethered to spot — the exchange is only the conduit, not the recipient ([Coinbase: Understanding funding rates](https://www.coinbase.com/learn/perpetual-futures/understanding-funding-rates-in-perpetual-futures)).
- **Liquidation fees *are* revenue.** When a leveraged position is [force-closed](/blog/risk-and-liquidation-engines), the venue typically charges a liquidation fee, and any margin remaining after closing often flows to an insurance fund.
...
That means your economics look a lot like an exchange's: fee revenue scales with the volume you drive, and derivatives let you capture fees on leveraged notional. What you *don't* carry is the multi-year cost of building and operating the engine. (For the full picture of what that build would otherwise cost, see our [cost breakdown](/blog/cost-to-launch-crypto-derivatives-exchange); and for the launch path, our [launch guide](/blog/how-to-launch-a-crypto-derivatives-exchange).)
