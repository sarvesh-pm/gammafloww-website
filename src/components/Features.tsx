...
import { TiltCard } from "./ui/Interactive";
            ...
            return (
              <Reveal key={f.title} delay={(i % 3) * 0.08} className="h-full">
                <TiltCard max={6} className="h-full">
                  <div className="group h-full rounded-2xl glass p-6 shadow-soft transition-colors duration-200 hover:border-brand/40 hover:shadow-glow">
